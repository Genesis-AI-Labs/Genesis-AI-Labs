        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-sm max-w-none">
            ...
            <section className="mb-16">
              <h2 className="text-2xl font-light mb-6">OUR VISION</h2>
            ...
            <section className="mb-16">
              <h2 className="text-2xl font-light mb-6">RESEARCH ORIENTATIONS</h2>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                <div className="space-y-4">
                  <h3 className="text-lg font-light">GEOMETRIC DEEP LEARNING POD</h3>
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-light">DEEP LEARNING POD</h3>
                  <ul className="text-sm text-gray-600 space-y-1">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-light">AI AGENTS</h3>
                  <ul className="text-sm text-gray-600 space-y-1">
            ...
            <section className="mb-16">
              <h2 className="text-2xl font-light mb-6">THE NEXT BIG THING</h2>
              <p className="text-sm text-gray-600 leading-relaxed mb-6">
            ...
            <section className="mb-16">
              <h2 className="text-2xl font-light mb-6">CLIMATE RESEARCH WING</h2>
              <p className="text-sm text-gray-600 leading-relaxed">
            ...
            <div className="mt-16">
              <Button variant="outline" className="rounded-full border-2 px-8 bg-transparent">
